...
rm -f /var/lib/pgpro/1c-13/data/postgresql.conf						# удаление старого файла конфигураций
cp /mnt/postgresql.conf /var/lib/pgpro/1c-13/data/ 					# перемещение нового файла конфигураций
#
#
